...
const run = (answers) => {
  ...
  const helpers = ['index.js', '.editorconfig', 'gulpfile.js/index.js', 'gulpfile.js/clean.js', 'gulpfile.js/helpers.js', 'gulpfile.js/.helpers.json', 'gulpfile.js/watch.json', 'gulpfile.js/.watch.json']
