...
const run = (answers) => {
  ...
  const libs = ['browser-sync', 'del', 'gulp', 'gulp-bump', 'gulp-cli', 'gulp-if', 'gulp-include', 'gulp-rename', 'gulp-sourcemaps', 'fancy-log', 'gulp-wait', 'gulp-exit', 'require-dir', 'run-sequence']
