  ...
  const questions = [
    {
      ...
      type: 'confirm',
      name: 'override2',
      message: '[General] Are you absolutely sure that you want to override the project, including config files?',
      ...
      type: 'input',
      name: 'html[pug]',
      message: '[HTML] Are you using pug as your template engine?',
