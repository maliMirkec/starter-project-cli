  ...
  const questions = [
    {
      ...
      default: config.getOptionValue('src') || 'src',
      validate(value) {
        if (value.length) {
          return true;
        }
      ...
      default: config.getOptionValue('dist') || 'dist',
      validate(value) {
        if (value.length) {
          return true;
        }
      ...
      default: config.getOptionValue('sync.run') || true,
      when(answers) {
      ...
      default: config.getOptionValue('html.run') || true,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('html.pug') || true,
      when(answers) {
      ...
      default: config.getOptionValue('html.data') || false,
      when(answers) {
      ...
      default: config.getOptionValue('html.inline') || false,
      when(answers) {
        return answers.override2 === true && answers.html.run === true && answers.html.pug === true;
      },
    }, {
      ...
      default: config.getOptionValue('html.src') || 'html',
      when(answers) {
        return answers.override2 === true && answers.html.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('html.minify') || true,
      when(answers) {
        return answers.override2 === true && answers.html.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('html.lint') || false,
      when(answers) {
        return answers.override2 === true && answers.html.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.run') || true,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.sass') || true,
      when(answers) {
      ...
      default: config.getOptionValue('css.src') || 'scss',
      when(answers) {
        return answers.override2 === true && answers.css.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.dist') || 'css',
      when(answers) {
        return answers.override2 === true && answers.css.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.minify') || true,
      when(answers) {
        return answers.override2 === true && answers.css.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.autoprefix') || true,
      when(answers) {
        return answers.override2 === true && answers.css.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.sourcemaps') || true,
      when(answers) {
        return answers.override2 === true && answers.css.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('css.lint') || false,
      when(answers) {
        return answers.override2 === true && answers.css.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('js.run') || true,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('js.src') || 'js',
      when(answers) {
      ...
      default: config.getOptionValue('js.dist') || 'js',
      when(answers) {
        return answers.override2 === true && answers.js.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('js.uglify') || true,
      when(answers) {
        return answers.override2 === true && answers.js.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('js.sourcemaps') || true,
      when(answers) {
        return answers.override2 === true && answers.js.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('js.lint') || false,
      when(answers) {
        return answers.override2 === true && answers.js.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('gfx.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('gfx.src') || 'gfx',
      when(answers) {
      ...
      default: config.getOptionValue('gfx.dist') || 'gfx',
      when(answers) {
        return answers.override2 === true && answers.gfx.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('fonts.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('fonts.src') || 'fonts',
      when(answers) {
      ...
      default: config.getOptionValue('fonts.dist') || 'fonts',
      when(answers) {
        return answers.override2 === true && answers.fonts.run === true;
      },
    }, {
      ...
      default: config.getOptionValue('favicon.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('critical.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('kss.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('kss.dist') || 'docs/styleguide',
      when(answers) {
      ...
      default: config.getOptionValue('sassdoc.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('sassdoc.dist') || 'docs/sass',
      when(answers) {
      ...
      default: config.getOptionValue('jsdoc.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('jsdoc.dist') || 'docs/js',
      when(answers) {
      ...
      default: config.getOptionValue('bump.run') || false,
      when(answers) {
        return answers.override2 === true;
      },
    }, {
      ...
      default: config.getOptionValue('yarn') || false,
      when(answers) {
        return answers.override2 === true;
      },
    },
